...
deleteLexicon = Request.request service method  where
    service = Request.ServiceName "Polly"
    method = Request.MethodName "deleteLexicon"
...
describeVoices = Request.request service method  where
    service = Request.ServiceName "Polly"
    method = Request.MethodName "describeVoices"
...
getLexicon = Request.request service method  where
    service = Request.ServiceName "Polly"
    method = Request.MethodName "getLexicon"
...
listLexicons = Request.request service method  where
    service = Request.ServiceName "Polly"
    method = Request.MethodName "listLexicons"
...
putLexicon = Request.request service method  where
    service = Request.ServiceName "Polly"
    method = Request.MethodName "putLexicon"
...
synthesizeSpeech = Request.request service method  where
    service = Request.ServiceName "Polly"
    method = Request.MethodName "synthesizeSpeech"
